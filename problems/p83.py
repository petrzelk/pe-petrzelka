...
Problem Description:
<p class="small_notice">NOTE: This problem is a significantly more challenging version
of <a href="problem=81">Problem 81.
...
up, and down in <a href="resources/documents/0083_matrix.txt">matrix.txt (right click
...
# Solutions
def p83(file_path: str = "..\\resources\\0083_matrix.txt") -> int:
  """The solution.
  """
  ...
  directions: set[tuple[int]] = {(-1,0),(0,-1),(1,0),(0,1)}
